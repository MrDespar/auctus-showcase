...
## Financial Formatting Terminology

| Incorrect / Casual | IB Standard |
|--------------------|-------------|
| "run rate" | "run-rate" (adjective: run-rate revenue) |
| "proforma" | "pro forma" |
| "year over year", "YOY" | "YoY" or "y-o-y" |
| "CAGR growth" | "CAGR" (growth is redundant) |
| "margin of 10%" | "10% margin" |
| "EBITDA of 10m" | "EBITDA of €10.0m" |
